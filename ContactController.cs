...
namespace Deeksha.Controllers
{
    ...
    public class ContactController : ControllerBase
    {
        ...
        {
            new Contact { Id = 1, FirstName = "Leonard", LastName = "Hofstadter", NickName= "Grumpy", place = "New Jersey"},
            new Contact { Id = 2, FirstName = "Sheldon", LastName = "Cooper", NickName= "Bazinga", place = "Texas"}
        };
